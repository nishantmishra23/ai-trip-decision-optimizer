"""
Script to populate data/india_tourism_data.py with full coverage of all 28 states of India.
Each state contains 4-8 destinations, complete with neighborhoods, places, activities, hotels, and dining.
"""
import os
import sys
import json
