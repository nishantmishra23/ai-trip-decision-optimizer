"""
Full Python dataset builder for data/india_tourism_data.py.
Covers all 28 Indian states with 4-8 destinations each, sub-regions, places, activities, hotels, and dining.
"""
import os
import sys
import json
...
def make_destination(name, tagline, overview, budget_daily, best_time, duration, rating, popularity, travel_style, suitability, weather_city, neighborhoods, places, activities, hotels, restaurants):
    for h in hotels:
...
# Let's write the builder function
def generate_all_states():
    ...
    s["Andhra Pradesh"] = {
        ...
        "destinations": [
            make_destination("Visakhapatnam", "The Jewel of the East Coast", "Coastal city with golden beaches, submarine museum, and scenic hill views.", 1800, "Oct–Mar", "3 Days", 4.7, 8.9, "Beach & Coastal City", ["Family", "Couples", "Solo", "Friends"], "Visakhapatnam",
            ...
            make_destination("Araku Valley", "The Valley of Coffee & Clouds", "Hill station in Eastern Ghats with organic coffee estates and prehistoric caves.", 1500, "Sep–Mar", "2 Days", 4.7, 8.5, "Hill Station & Nature", ["Family", "Couples", "Friends", "Solo"], "Araku Valley",
            ...
            make_destination("Tirupati", "The Spiritual Capital of Andhra", "World famous pilgrimage center at the base of the holy Seven Hills of Tirumala.", 1400, "Sep–Mar", "2 Days", 4.8, 9.7, "Spiritual & Heritage", ["Family", "Solo", "Couples"], "Tirupati",
            ...
            make_destination("Gandikota", "The Grand Canyon of India", "Spectacular 300-ft red granite gorge carved by the Pennar River.", 1300, "Oct–Feb", "2 Days", 4.7, 8.4, "Adventure & Nature", ["Friends", "Solo", "Couples"], "Kadapa",
            ...
            make_destination("Vijayawada", "The Heart of the Krishna River", "Vibrant city with hill temples, rock-cut Buddhist caves, and river island recreation.", 1600, "Oct–Mar", "2 Days", 4.5, 8.3, "Heritage & River", ["Family", "Business", "Solo"], "Vijayawada",
